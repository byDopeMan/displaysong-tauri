 ...
 */
export async function getCustomLanguages() {
 ...
 */
export async function populateLanguageSelect() {
 ...
 */
export function t(key, params = {}, defaultValue = key) {
  ...
  if (!value || value === key) return defaultValue;
